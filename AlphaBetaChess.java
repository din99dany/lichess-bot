...
public class AlphaBetaChess {
    ...
    static int globalDepth=5;	//depth of best move searching
    ...
    public static String makeJsonMove(String g) {
        if ( !g.equals("")) {
            JSONObject gameState = new JSONObject(g);
            if (gameState.has("moves")) {

                String last_move = gameState.getString("moves");
                String[] moves = last_move.split(" ");
                String final_move = moves[moves.length - 1];
                System.out.println("Player -------------- " + playerColor);
                System.out.println("Request: " + g.toString());
                System.out.println("final move: " + final_move);

                final_move = "" +
                        (char) ( '8' - final_move.charAt(1)  + '0') +
                        (char) ( final_move.charAt(0) - 'a' + '0') +
                        (char) ( '8'- final_move.charAt(3) + '0' )+
                        (char) ( final_move.charAt(2) - 'a' + '0') +
                        " ";
                System.out.println("final move: " + final_move);
                ...
                if (playerColor == 1) {
                    ...
                    String newMove = alphaBeta(5, Integer.MAX_VALUE, Integer.MIN_VALUE, "", 0);
                    ...
                    String lichessMove = "" +
                            (char) ( 'a' - newMove.charAt(1)  + '7') +
                            (char) (newMove.charAt(0) + 1) +
                            (char) ( 'a' - newMove.charAt(3)  + '7') +
                            (char) (newMove.charAt(2) + 1);
                    System.out.println("Lichess move: " + lichessMove);
                    System.out.println("----------------------");
